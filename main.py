...
def Traps(enemyimg: Image, num: number):
    global enemmy
    for index in range(num):
        enemmy = sprites.create(enemyimg, SpriteKind.enemy)
        enemmy.follow(Hero, 10)
        tiles.place_on_random_tile(enemmy, sprites.dungeon.door_closed_north)
...
Hero = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
Hero.say_text("I need to collect ALL the fires", 500, False)
tiles.set_current_tilemap(tilemap("""
    level2
"""))
controller.move_sprite(Hero)
scene.camera_follow_sprite(Hero)
tiles.place_on_random_tile(Hero, sprites.dungeon.door_open_north)
info.set_score(0)
spawned = False
gamepoints = False
winPoints = False
